...
int main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[])
{
    ...
    file_reader -> SetFile("../../../gem_cleanroom_2252.evio.0");
    ...
    MPDVMERawEventDecoder *mpd_vme_decoder = new MPDVMERawEventDecoder();
    ...
    while(file_reader->ReadNoCopy(&pBuf, &fBufLen) == S_SUCCESS)
    {
        ...
        [[maybe_unused]] auto & decoded_data = mpd_vme_decoder->GetAPV();
