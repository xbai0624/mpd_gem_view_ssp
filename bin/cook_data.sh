...
#./bin/replay.app/Contents/MacOS/replay -t 1 -z 0 ../data/fermilab_beamtest_6.evio.0

# convert evio file to root files
./bin/replay.app/Contents/MacOS/replay -c true -z 0 ../data/fermilab_beamtest_6.evio.0
