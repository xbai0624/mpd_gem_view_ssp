...
./bin/replay --pedestal database/gem_ped_55.dat --common_mode database/CommonModeRange_55.txt /home/xinzhan/evio_data/fermilab_test/fermilab_beamtest_8.evio.0
