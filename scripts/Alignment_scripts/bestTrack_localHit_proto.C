...
void bestTrack_localHit(const char *clusterRootName = "default") 
{
  ...
  //gSystem->Load("libPhysics");
	...
	if(tracker0 != 2 || tracker1 != 2 || tracker5 != 2 || tracker6 != 2 || prototype != 2) continue;
	...
	healthFile << "Prototype Cluster Count (X+Y): " << prototype << std::endl;
        healthFile << "Prototype X Axis Cluster Num: " << prototype_x << endl;
        healthFile << "Prototype y Axis Cluster Num: " << prototype_y << endl;
